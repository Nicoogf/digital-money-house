...
export default function Home() {
  return (
    ...
    '>
      ...
      <span className="block relative after:content-[''] after:block after:w-14 after:h-[2px] after:bg-lemon after:ml-4 sm:after:ml-8 after:rounded-lg">
      </span>
      ...
      <article className="bg-lemon flex flex-col items-center gap-y-4 absolute bottom-0 rounded-t-lg">

        <a className="bg-white w-[90%] rounded-lg p-3 relative -top-6 cursor pointer
                       sm:w-[70%] sm:py-8
                       " 
           href="./transferir">
        ...
        <a className="bg-white w-[90%] rounded-lg p-3 relative -top-6 cursor pointer
         ...
         <h4 className="font-semibold text-lg relative after:content-[''] after:block after:w-[90%] after:h-[2px] after:bg-lemon after:rounded-lg after:mb-2
         sm:text-2xl sm:after:mb-4"> 
         Pago de Servicios
         </h4>

         <p className="text-xs sm:text-base"> 
          Paga mensualmente los servicios en 3 simples clicks, Facil, rapido y convieniente. Olvidate de las facturas en papel.
         </p>
