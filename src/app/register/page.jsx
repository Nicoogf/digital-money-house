    ...
    '>
     ...
     <form className='flex flex-col  gap-y-2
        ...
        <div className='grid grid-cols-2 gap-y-2 w-[80%] mx-auto mb-2
                        xs:w-[70%] xs:gap-y-3 xs:w-[90%] xs:mb-6
                        sm:gap-x-3'>
          ...
          <a className='col-span-2 bg-lemon text-center font-semibold cursor-pointer border-2 
                        border-transparent hover:bg-gray-900/70 hover:text-lemon hover:border-lemon
                        transition-all duration-500 py-1 rounded-lg                        
                        sm:col-span-1 sm:py-
                        sm:text-xl sm:py-4                               
                        lg:text-xl'
                    href="./"
